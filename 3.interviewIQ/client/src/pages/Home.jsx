          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div
                  ...
                  role="button"
                  tabIndex={0}
                  onClick={() => requireAuthNavigate("/interview")}
                  onKeyDown={(e) => cardKeyActivate(e, "/interview")}
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  const path = index === 3 ? "/history" : "/interview"
                  return (
                  <motion.div
                    key={index}
                    role="button"
                    tabIndex={0}
                    onClick={() => requireAuthNavigate(path)}
                    onKeyDown={(e) => cardKeyActivate(e, path)}
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    whileHover={{ scale: 1.02 }}
                    className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all cursor-pointer'>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  const path = index === 3 ? "/pricing" : "/interview"
                  return (
                  <motion.div
                    key={index}
                    role="button"
