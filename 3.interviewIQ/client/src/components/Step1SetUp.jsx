    ...
    const handleStart = async () => {
        ...
        try {
           ...
           onStart(result.data)
            ...
            console.log(error)
            const msg = error?.response?.data?.message || error?.message || "Could not start interview."
            setStartError(typeof msg === "string" ? msg : "Could not start interview.")
            setLoading(false)
        }
    }
    return (
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                        ...
                        {startError && (
                            <p className="text-red-600 text-sm" role="alert">{startError}</p>
                        )}
